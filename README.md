...
### 1. What is the IP address of the virtual machine?

```
192.168.56.107
```

### 2. What resources does the virtual machine have?

- **CPU**: 2
- **Memory**: 2 GB

### 3. What domain was assigned by Ngrok?

```
amazingly-proper-cod.ngrok-free.app
```

### 4. What are the usernames and passwords for the protected pages?

- **Admin**: `admin / asir`
- **Status**: `sysadmin / risa`

---

## Author

This project was developed as part of a practice on web server configuration and administration.
